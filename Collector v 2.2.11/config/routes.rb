Rails.application.routes.draw do
  ...
  get 'super_admin/admin/index' => 'providers#admin_index', as: :av_show_all_admins
  get 'super_admin/admin/index/:admin_id/edit' => 'providers#admin_edit', as: :av_edit_admin
